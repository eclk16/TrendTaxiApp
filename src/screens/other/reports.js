...
import {BackHandler, ActivityIndicator, View, Text, ScrollView} from 'react-native';
                                ...
                                <View style={[tw`rounded-md mb-2`, stil('bg', data.app.theme)]}>
                                    <Text
                                        style={[
                                            ...
                                            tw`text-center  p-2 font-medium`,
                                        ]}>
