...
export default function SetConfigurationExample() {
    ...
    const [authorizationLevel, setAuthorizationLevel] = useState<'whenInUse' | 'always' | 'auto'>(
        'auto',
    );
    const [locationProvider, setLocationProvider] = useState<'playServices' | 'android' | 'auto'>(
        'auto',
    );
    useEffect(() => {
