...
function HomePage() {
    ...
    Geolocation.watchPosition(
        ...
        (error) => {
            setCurrent(data.auth.user.last_location);
    ...
    useEffect(() => {
        ...
        channel.bind('trip', function (data2) {
            if (data2.trip.prc == 'delete_trip') {
                try {
                    SetBitenTrip(data2.trip.trip.act_price);
                    setModalOpen(true);
                } catch (e) {
                    console.log('EEE = ', e);
                }
    ...
    const [bitenTrip, SetBitenTrip] = React.useState([]);
    const deleteTrip = (bitti = null) => {
        ...
        axios
            ...
            .then((response) => {
                // try {
                //     SetBitenTrip(response.data.trip.act_price);
                //     setModalOpen(true);
                // } catch (e) {
                //     console.log('EEE = ', e);
                // }
    ...
    return (
        <>
            ...
            <View style={[tw` w-full flex-1`]}>
                ...
                {/* <TouchableOpacity
                    style={[
                        {position: 'absolute', zIndex: 9999999, bottom: 140, right: 20},
                        stil('bg2', data.app.theme),
                        tw` flex-row items-center justify-center p-2  rounded-md }`,
                    ]}
                    onPress={() => {
                        getCurrentLocation();
                    }}>
                    ...
                    {data.trip.trip.status2 == 2 ? (
                        <>
                            ...
                            <TouchableOpacity
                                ...
                                <Text
                                    style={[tw`font-semibold mr-2`, stil('text', data.app.theme)]}>
            ...
            <Modal
                ...
                <View
                    ...
                    <View
                        style={[
                            tw` w-[90%] flex items-center justify-end rounded-md`,
                            stil('bg', data.app.theme),
                        ]}>
                        <View style={[tw`  w-full`]}>
                            <Text
                                style={[
                                    tw`font-bold text-center text-3xl mt-4`,
                                    stil('text', data.app.theme),
                                ]}>
                                {bitenTrip}
                            </Text>
                            <Text
                                style={[
                                    tw`font-bold text-center text-xl `,
                                    stil('text', data.app.theme),
                                ]}>
                                sum
                            </Text>
                        ...
                        <TouchableOpacity
                            style={[
                                tw`flex-row items-center justify-center p-2 m-2 rounded-md w-1/3`,
                            ...
                            onPress={() => {
                                ...
                                navigation.navigate(
                                    data.auth.userType == 'passenger' ? 'Home' : 'HomeDriverPage',
                                );
                            }}>
                            <MaterialCommunityIcons
                                name="check"
