...
function Trips() {
  ...
  return (
    <>
      <StatusBarComponent />
      <ScrollView
        style={[stil('bg', data.app.theme), tw`p-4 flex-1`]}
          ...
          {trips.map((trip, index) => {
            return (
              <TouchableOpacity
                ...
                <View
                  style={[
                    tw`flex rounded-md mb-5 bg-white px-2 py-4`,
                    {backgroundColor: data.app.theme == 'dark' ? '#255382' : '#f9f9f7'},
                  ]}>
                    ...
                    <View style={[tw`flex-row px-2 `]}>
                      <View style={tw`w-4/4`}>
                        <View style={[tw`mb-2 flex flex-row items-center justify-center`]}>
                          ...
                          />
                          <Text style={[tw`flex-auto ml-2 text-xs`, stil('text', data.app.theme)]}>
                            {trip.first_location_name}
                          </Text>
                        </View>
