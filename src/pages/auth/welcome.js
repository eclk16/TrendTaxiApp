...
export default function Welcome() {
    ...
    const loginFunction = () => {
        if (userPhone.length == 12) {
            ...
            axios
                .post('https://trendtaxi.uz/api/login', {
                    phone: userPhone,
                    deviceToken: getUniqueId(),
                    userType: wusertype,
                })
    ...
    const smsFunction = () => {
        ...
        axios.defaults.headers.common['Content-Type'] = 'application/json';
        axios
            .post('https://trendtaxi.uz/api/SmsCheck', {smsCode: userSms, id: data.auth.userId})
            .then((response) => {
                if (!response.data.data.hata) {
                    let json = {
                ...
                <View style={[tw`flex justify-end`]}>
                    <View style={[tw`flex-row justify-center items-center `]}>
                        <MaterialCommunityIcons
                            name={step == 1 ? 'alphabetical-variant' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                        <MaterialCommunityIcons
                            name={step == 2 ? 'theme-light-dark' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                        <MaterialCommunityIcons
                            name={step == 3 ? 'security' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                        <MaterialCommunityIcons
                            name={step == 4 ? 'human' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                        <MaterialCommunityIcons
                            name={step == 5 ? 'phone' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                        <MaterialCommunityIcons
                            name={step == 6 ? 'android-messages' : 'circle-small'}
                            size={40}
                            color={stil('text', data.app.theme).color}
                        />
                    </View>
                    <View>
                        {step == 1 && (
                            <>
                                <Text style={[tw`my-2 text-center`, stil('text', data.app.theme)]}>
                                ...
                                <View style={[tw`m-4 flex justify-center rounded-md`]}>
                                    <TouchableOpacity
                                        ...
                                        <View style={[tw`flex-row items-center justify-between `]}>
                                            ...
                                            />
                                            <Text
                                                style={[tw`  ml-4`, stil('text', data.app.theme)]}>
                        ...
                        {step == 3 && (
                            <>
                                ...
                                <Text
                                    style={[
                                        tw`my-2 text-xs text-center mx-4`,
                                        stil('text', data.app.theme),
                                    ]}>
                                ...
                                <View style={[tw`m-4 flex justify-center rounded-md`]}>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <View style={[tw`flex-row items-center justify-between `]}>
                                            ...
                                            />
                                            <Text style={[tw` ml-4`, stil('text', data.app.theme)]}>
                                                {l[data.app.lang].passengerLogin}
                                            </Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                        ...
                        {step == 5 && (
                            <>
                                <Text style={[tw`my-2 text-center`, stil('text', data.app.theme)]}>
                                    {l[data.app.lang].TelefonGir}
                                </Text>
                                <Text
                                    style={[
                                        tw`my-2 mx-4 text-xs text-center`,
                                        stil('text', data.app.theme),
                                    ]}>
                                ...
                                <View
                                    style={[
                                        stil('bg2', data.app.theme),
                                        tw`mx-8 my-4 flex justify-center rounded-md`,
                                    ]}>
                                    <View
                                        key={0}
                                        style={[tw`flex-row items-center m-4 justify-between`]}
                                        onPress={() => getLocation()}>
                                        <View style={[tw`flex-row items-center justify-between `]}>
                                            <MaterialCommunityIcons
                                                name="cellphone"
                        ...
                        <View style={[tw`flex-row`]}>
                            {step != 1 ? (
                                <TouchableOpacity
                                    ...
                                    <MaterialCommunityIcons
                                        name={
                                            step == 1 ? 'car-key' : 'arrow-left-drop-circle-outline'
                                        }
                                        size={16}
                                        style={[tw`${step == 1 ? 'opacity-80' : ''}`]}
                                        color={stil('text', data.app.theme).color}
                                    />
                                    <Text
                                        style={[
                                            stil('text', data.app.theme),
                                            tw`my-2 ml-2  ${step == 1 ? 'opacity-80' : ''}`,
                                        ]}>
                                        {step == 1
                                            ? l[data.app.lang].dregister
