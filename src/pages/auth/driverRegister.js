...
export default function DriverRegister({isDriver, setIsDriver}) {
  ...
  const pt = {
    ...
    footerView: [tw`flex-row px-4 pb-4 items-center justify-end`, stil('bg', data.app.theme)],
  ...
  const [driverImage, setDriverImage] = React.useState(
    require('../../assets/img/orneksurucu.jpeg'),
  );
  const [uploadDriverImage, setUploadDriverImage] = React.useState('');

  const [driverLicenseImage, setDriverLicenseImage] = React.useState(
    require('../../assets/img/ornekehliyet.jpeg'),
  );
  const [uploadDriverLicenseImage, setUploadDriverLicenseImage] = React.useState('');

  const [driverRuhsatImage, setDriverRuhsatImage] = React.useState(
    require('../../assets/img/ornekruhsat.jpeg'),
  );
  const [uploadDriverRuhsatImage, setUploadDriverRuhsatImage] = React.useState('');

  const [driverCarImage, setDriverCarImage] = React.useState(
    require('../../assets/img/ornekarac1.jpeg'),
  );
  const [uploadDriverCarImage, setUploadDriverCarImage] = React.useState('');

  const [driverCarImage2, setDriverCarImage2] = React.useState(
    require('../../assets/img/ornekarac2.jpeg'),
  );
    ...
    <>
      <SafeAreaView style={pt.sav}>
        ...
        <View style={[tw`flex justify-end`]}>
          ...
          <View style={[tw`flex-row justify-center items-center `]}>
            <MaterialCommunityIcons
              name={step == 1 ? 'account' : 'circle-small'}
              size={40}
              color={stil('text', data.app.theme).color}
            />
            <MaterialCommunityIcons
              name={step == 2 ? 'file-document' : 'circle-small'}
              size={40}
              color={stil('text', data.app.theme).color}
            />
            <MaterialCommunityIcons
              name={step == 3 ? 'car' : 'circle-small'}
              size={40}
              color={stil('text', data.app.theme).color}
            />
          </View>
                ...
                <View style={[tw`m-4 rounded-md`]}>
                  <TextInput
                    style={[
                      ...
                      tw`p-2 pl-4 rounded-md my-2 text-base`,
                  ...
                  <TextInput
                    ...
                    placeholderTextColor={stil('text', data.app.theme).color}
                    value={plaka}
                    placeholder={l[data.app.lang].plaka}
            ...
            {step == 2 && (
              <>
                <View style={[tw`m-4 rounded-md`]}>
                  <View
                    style={[
                      tw`rounded-md p-2 flex-row items-center justify-start`,
                      stil('bg2', data.app.theme),
                    ]}>
                    ...
                    <View style={[tw`ml-4`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('driver')}>
                        <Text style={[tw` w-3/4`, stil('text', data.app.theme)]}>
                          {l[data.app.lang].diu}
                        </Text>
                      </TouchableOpacity>
                    </View>
                  ...
                  <View
                    style={[
                      tw`rounded-md p-2 mt-2 flex-row items-center justify-start`,
                      stil('bg2', data.app.theme),
                    ]}>
                    <View style={[tw`h-12 w-12`]}>
                      {driverLicenseImage ? (
                        <Image
                          style={[tw`rounded-md`, {height: '100%', width: '100%'}]}
                          source={driverLicenseImage}
                        />
                      ) : null}
                    </View>
                    <View style={[tw`ml-4`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('license')}>
                        <Text style={[tw` w-3/4`, stil('text', data.app.theme)]}>
                  ...
                  <View
                    ...
                    <View style={[tw`h-12 w-12`]}>
                      {driverRuhsatImage ? (
                        <Image
                          style={[tw`rounded-md`, {height: '100%', width: '100%'}]}
                          source={driverRuhsatImage}
                        />
                      ) : null}
                    </View>
                    <View style={[tw`ml-4`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('ruhsat')}>
                        <Text style={[tw` w-3/4`, stil('text', data.app.theme)]}>
                  ...
                  <View
                    ...
                    <View style={[tw`h-12 w-12`]}>
                      {carCertificateImage ? (
                        <Image
                          style={[tw`rounded-md`, {height: '100%', width: '100%'}]}
                          source={carCertificateImage}
                        />
                      ) : null}
                    </View>
                    <View style={[tw`ml-4`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('carB')}>
                        <Text style={[tw` w-3/4`, stil('text', data.app.theme)]}>
            ...
            {step == 3 && (
              <>
                <View style={[tw`m-4 flex-row items-center justify-between rounded-md`]}>
                  <View
                    style={[
                      tw`rounded-md p-2 mt-2 flex items-center justify-center`,
                      stil('bg2', data.app.theme),
                    ]}>
                    <View style={[tw`h-20 w-32`]}>
                      {driverCarImage ? (
                        <Image
                          style={[tw`rounded-md`, {height: '100%', width: '100%'}]}
                          source={driverCarImage}
                        />
                      ) : null}
                    </View>
                    <View style={[tw`w-24 mt-2`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('car')}>
                  ...
                  <View
                    ...
                    <View style={[tw`h-20 w-32`]}>
                      {driverCarImage ? (
                        <Image
                          style={[tw`rounded-md`, {height: '100%', width: '100%'}]}
                          source={driverCarImage2}
                        />
                      ) : null}
                    </View>
                    <View style={[tw`w-24 mt-2`]}>
                      <TouchableOpacity onPress={() => getPhotoWithPhone('car2')}>
                        <Text style={[tw`text-center`, stil('text', data.app.theme)]}>
                          {l[data.app.lang].dciu}
                        </Text>
                      </TouchableOpacity>
            ...
            <View style={[tw`flex-row justify-end `]}>
              ...
              {step != 3 ? (
                <TouchableOpacity
                  style={[
                    tw`flex-row ${
                      step == 4 && userPhone.length < 12
                        ? 'opacity-10'
                        : step == 5 && userPhone.length < 6
                        ? 'opacity-10'
                        : ''
      ...
      <Modal
        ...
        <View
          ...
          <View
            style={[
              tw` w-[95%] flex items-center justify-center rounded-md p-2`,
            ...
            <View style={[tw`mb-4  w-full`]}>
              ...
              <Text style={[tw` text-center mb-2`, stil('text', data.app.theme)]}>
                {l[data.app.lang].sonucSms}
              </Text>
